...
class SymlinkDumper
{
    ...
    public function dump(array $packageIds, $force = false, $verbose = false)
    {
        ...
        try {
            ...
            $this->rootFile['warning'] = 'Drupal Packagist is deprecated, you should use the official Package Repository from Drupal.org instead. See https://www.drupal.org/node/2822344 for more information.';
